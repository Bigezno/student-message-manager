...
public class RandomPictureController {
	...
	@RequestMapping("/RandomPicture.do")
	public void randomPicture(HttpServletRequest request,HttpServletResponse response)
		...
		//response.setHeader("refresh", "5");//设置refresh响应头控制浏览器每隔5秒钟刷新一次
				...
				String random = drawRandomNum(g,createTypeFlag);//根据客户端传递的createTypeFlag标识生成验证码图片
				
				//7.将随机数保存在Session中让CheckServlet对表单提交上来的数据进行验证
				request.getSession().setAttribute("checkcode",random);
				System.out.println("checkcode ="+random);
				
				//8.设置响应头控制浏览器浏览器以图片的方式打开
			...
			private String drawRandomNum(Graphics2D g, String  createTypeFlag) {
				...
				g.setFont(new Font("宋体", Font.BOLD, 20));//设置字体,不指定字体名字,粗体，20大小
				
				//常用的中国汉字
			    String baseChineseChar = "\u7684\u4e00\u4e86\u662f\u6211\u4e0d\u5728\u4eba\u4eec\u6709"
			    		+ "\u6765\u4ed6\u8fd9\u4e0a\u7740\u4e2a\u5730\u5230\u5927\u91cc\u8bf4\u5c31\u53bb"
			    		+ "\u5b50\u5f97\u4e5f\u548c\u90a3\u8981\u4e0b\u770b\u5929\u65f6\u8fc7\u51fa\u5c0f"
			    		+ "\u4e48\u8d77\u4f60\u90fd\u628a\u597d\u8fd8\u591a\u6ca1\u4e3a\u53c8\u53ef\u5bb6"
			    		+ "\u5b66\u53ea\u4ee5\u4e3b\u4f1a\u6837\u5e74\u60f3\u751f\u540c\u8001\u4e2d\u5341"
			    ...
			    String baseNumLetter = "0123456789ABCDEFGHJKLMNOPQRSTUVWXYZ";//数字和字母组合
			    String baseNum = "0123456789";//纯数字组合
			    String baseLetter="abcdefghijklmnopqrstuvwxyz";//纯字母组合
			    
			  //createTypeFlag[0]==null表示没有传递参数
			    if(null!=createTypeFlag){
			...
			private String createRandomChar(Graphics2D g, String baseChar) {
				...
				int x = 5;   //长120，分为4个数字，每个数字栈20长，让每个数字间隔10，与边界间隔5
				String ch="";
				//控制字数
				for(int i=0;i<4;i++){
					//设置字体旋转角度
					...
					sb.append(ch);
					//正向角度
					g.rotate(degree * Math.PI / 180, x, 20);//rotate(double theta,double x, double y)x,y是圆心的位置。 Math.PI / 180 = 1度
					g.drawString(ch,x,20);//在x坐标为5的地方，写长度为20的String
